...
<th>Description</th>
 ...
 <td>
                           ...
                           <td><a href="edit.php?id=<?php echo $role['id']; ?>" class="edit"><i class="bi bi-pencil-square"></i></a></td>
                           <td><a href="index.php?del_id=<?php echo $role['id']; ?>" class="delete"><i class="bi bi-trash3"></i></a></td>
