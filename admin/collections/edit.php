...
<body>
    <?php include(ROOT_PATH . "/app/includes/sidebar/collections.php"); ?>
    <div class="main-content" id="main-content">
        ...
        <main>
            <div class="wrapper flex">
                <div class="obt">
                    <a href="create.php"><button class="nbtn">Add Collections</button></a>
                    <a href="index.php"> <button class="nbtn">Manage Collections</button></a>
                </div>
                <div class="projects1">
                    ...
                    <form action="create.php" method="post">
                        ...
                        <div>
                            ...
                            <div>
                                ...
                                <button type="submit" class="button2">Update Collection</button>
                            </div>
                    </form>
                </div>
            </div>
