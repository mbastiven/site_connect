            ...
            <div class="form1">
               <form action="create.php" method="post" enctype="multipart/form-data">
                  ...
                  <div>
                     ...
                     <input type="datetime-local" name="event_day" value="<?php echo $event_day; ?>" class="text-input">
                  </div>
                  <div>
                  ...
                  <div>
                    <div class="pc">
                    <label>Price</label>
                     <select name="price" id="price" placeholder="Select">
                        <option value="">Select</option>
                  ...
                  <div id="amount" style="display:none;">
                     ...
                     <input type="number" name="amount" placeholder="Amount in CFA"/>
                     </div>

                     </div>
                     <label>Description</label>
                     <textarea value="<?php echo $description; ?>" name="description" id="description"
                  ...
                  <?php endif; ?>
                  <div>
                     <button type="submit" name="add-event" class="button2">Add Event</button>
