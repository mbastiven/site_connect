...
<body>
    ...
    <div class="main-content" id="main-content">
        ...
        <form action="edit.php" method="post">
                     ...
                     <input type="number" name="limits" value="<?php echo $limits; ?>" class="text-input">
                  </div>
                        <div>
                        ...
                        <div>
                            <button type="submit" name="update-subscription" class="button2">Update subscription</button>
                        </div>
                    </form>
                </div>
            </div>
