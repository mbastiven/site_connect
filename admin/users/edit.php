                ...
                <div class="form3">
                    <form action="edit.php" method="post" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            <input type="password" value="<?php echo $passwordConf; ?>" name="passwordConf"
                                class="text-input" placeholder="Confirm Password">
                        </div>
                                  <div>
                  ...
                  <div>
                     ...
                     <select name="subscription_id" id="" placeholder="Select">
                        ...
                        <div>
                            <button type="submit" name="update-user" class="button2">Update User</button>
                        </div>
                    </form>
                </div>
            </div>
