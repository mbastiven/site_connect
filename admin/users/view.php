   ...
   <div class="col-lg-8" >
      <div class="card z-depth-3">
         <div class="card-body">
            ...
            <div class="tab-content p-3">
               <div class="tab-pane active show" id="profile">
                  ...
                  <div class="card-body text-center bg-primary rounded-top">
                     ...
                     <h6 class="text-light">
                     <?php if (empty($user['id']) || 1 !== $user['role_id']): ?>
                     ...
                     <li class="list-group-item" >
                        <div class="row text-center mt-6">
                           ...
                           <div class="col p-2">
                              ...
                              <span>
                                 <?php echo $user['full_address']; ?>
                              </span>
                              <small class="tt">Full Address</small>
                           </div>
                           <div class="col p-2">
                           <i class="bi bi-globe"></i>
                           <span>www.evently/<?php echo $user['username']; ?>.com
                           </span>
            ...
            <div class="note">
                <p>
                    Nb:  read this ... <br>  1-  Here you see all data and information oa a user
                    <br> 2- You can also go back the edit these data and information 
                </p>
            </div>
